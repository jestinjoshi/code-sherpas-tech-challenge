...
export default function Home() {
  ...
  return (
    <main className="flex flex-col p-5 md:p-14 min-h-screen bg-[#025257]">
      <div className="container mx-auto">
        <h1 className="text-4xl mb-1 text-white">Hi, <span className="user-name min-w-10 inline-block h-full">User</span></h1>
        ...
        <div className="grid items-center rounded-lg border border-gray-100 bg-white p-4 gap-6 stats mb-10 grid-cols-1 sm:grid-cols-2">
          ...
          <div className="flex gap-5 justify-self-center sm:justify-self-end">
            <div onClick={() => setFormVisibility('deposit')} className="flex flex-col text-center items-center cursor-pointer relative transaction-button deposit p-2">
              <span className="rounded-full bg-green-100 p-3 text-green-600 mb-1 z-10">
              ...
              <p className="text-sm text-gray-500 z-10">Deposit</p>
            </div>
            <div onClick={() => setFormVisibility('withdraw')} className="flex flex-col items-center text-center cursor-pointer relative transaction-button withdraw p-2">
              <span className="rounded-full bg-red-100 p-3 text-red-600 mb-1 z-10">
              ...
              <p className="text-sm text-gray-500 z-10">Withdraw</p>
            </div>
            <div onClick={() => setFormVisibility('transfer')} className="flex flex-col items-center text-center cursor-pointer relative transaction-button transfer p-2">
              <span className="rounded-full bg-yellow-200 p-3 text-yellow-700 mb-1 z-10">
              ...
              <p className="text-sm text-gray-500 z-10">Transfer</p>
            </div>
          </div>
        </div>
                ...
                <tr>
                  <th className="whitespace-nowrap px-4 py-2 font-medium text-gray-900 flex items-center">
                    ...
                    <div className="flex-col flex cursor-pointer" onClick={() => setIsAscending(!isAscending)}>
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" className="h-3 w-5 rotate-180" fill={!isAscending ? 'black' : 'gray'}>
                        <path d="M182.6 41.4c-12.5-12.5-32.8-12.5-45.3 0l-128 128c-9.2 9.2-11.9 22.9-6.9 34.9s16.6 19.8 29.6 19.8l256 0c12.9 0 24.6-7.8 29.6-19.8s2.2-25.7-6.9-34.9l-128-128z" />
                      </svg>
                    </div>
                  </th>
